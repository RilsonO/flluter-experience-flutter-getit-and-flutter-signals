...
class PreCheckingPage extends StatefulWidget {
  const PreCheckingPage({super.key});

  @override
  State<PreCheckingPage> createState() => _PreCheckingPageState();
}

class _PreCheckingPageState extends State<PreCheckingPage>
